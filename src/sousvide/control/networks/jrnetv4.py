...
class JRNetv4(BaseNet):
    def __init__(self,
        ...
        super(JRNetv4, self).__init__(inputs,outputs,network_type)
    ...
    def forward(self,
        ...
        znn = self.networks["decoder"](tgt, mem)

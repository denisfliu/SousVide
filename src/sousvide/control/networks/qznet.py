...
class QZNet(BaseNet):
    def __init__(self,
                 ...
                 network_type="qznet"):
        """
        Initialize a QingZheng Network model.
        ...
        super(QZNet, self).__init__(inputs,outputs,network_type)
        ...
        ft_extract = vit_b_16(weights=ViT_B_16_Weights.IMAGENET1K_V1)
        
        icr_embed = nn.Linear(d_icr, d_model)
        xcr_embed = nn.Linear(d_xcr, d_model)
